...
public class LazarusGame extends Canvas implements Runnable {
  ...
  public LazarusGame() {
    ...
    level = loader.loadImage("/resources/LazarusSimpleMap.png");
  ...
  public void levelComplete() { // your method
    ...
    message ="Level Complete! Current level is " + currentLevel;
    if (currentLevel == 1) { // set lvl1
      ...
      loader = new ImageLoader();
      level = loader.loadImage("/resources/LazarusSimpleMap2.png");
      background = loader.loadImage("/resources/Background.png");
      lives = loader.loadImage("/resources/heart.png");

      loadLevel(level);
    } else if (currentLevel > 2) { // completed
  ...
  public void tick() {
    ...
    if (handler.nextLevel() && playerLives != 0) {
      message ="Level Complete! Current level is " + currentLevel;
      handler.resetLevel();
      handler.nextLevel();
    }
